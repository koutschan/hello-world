...
$k$ is some field and $t$ is another variable, and $R$ is typically~$C(x)$.
Integration will always be with respect to~$x$, but
...
rational functions $p/q$ with $\deg(p)\leq\deg(q)$.
