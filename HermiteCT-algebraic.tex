...
Then the module $K[x]^n$ viewed as a $K$-vector space is spanned by
\[
...
\begin{defi}\label{DEF:polyred}
Let $N_V$ be the $K$-subspace of $K[x]^n$ spanned by
\[
...
$\vec{q}\,$ is a linear combination of $\vec{B}_i$'s. Then $K[x]_m^n = C_B \oplus N_V$.
