...
\begin{example}
  The algebraic $f(x,t)=\frac1{\sqrt{x(x-1)(x-t)}}$ does not admit an elementary integral with respect to~$x$.
  ...
  This implies
  \[
    P\cdot \int_0^1 f(x,t)dx = \Bigl[\frac{2x(x-1)}{t-x}f(x,t)\Bigr]_{x=0}^1,
  \]
