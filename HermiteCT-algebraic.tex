...
The second way consists in showing that the vector space generated by $\{\,[\partial_t^i\cdot f]:i\in\set N\,\}$
...
be such that $V = TW$ is normal at $0$ and integral at any other places (including infinity).
...
\newblock {\em Izv. Akad. Nauk SSSR Ser. Mat.}, 22(6): 737--756, 1958.
