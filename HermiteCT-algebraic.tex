...
Throughout the paper, let $C$ be a field, $K=C(t)$, and $\bar K$ the algebraic closure of~$K$.
...
\[
  \bar K\<x^{-1}>:=\bigcup_{r\in\set N\setminus\{0\}} x^{-\nu}\bar K((x^{-1/r}))
\]
...
\begin{theorem}\label{thm:intiff0}
  Let $f\in A$ be such that
  $f$ has a double root at infinity (i.e., every series in $\bar K\<x^{-1}>$
  associated to $f$ only contains monomials $(1/x)^\alpha$ with $\alpha\geq2$). Let $W=\{\omega_1,\dots,\omega_n\}$
