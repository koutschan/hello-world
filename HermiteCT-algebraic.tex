...
Then
\[ h = \sum_{i=1}^n \frac{h_i \omega_i}{de}= \sum_{i=1}^n ((\frac{b_i}{a})' \omega_i + \frac{b_i}{a e} \sum_{j=1}^n  m_{i, j}\omega_j)).\]
...
\[h_i = u_i d + v_i e.\]
Then we get
\[ \sum_{i=1}^n \frac{h_i\omega_i}{de} =  \sum_{i=1}^n \left(\frac{u_i}{e} + \frac{v_i}{d}\right)\omega_i.\]
