...
\def\<#1>{\langle\!\langle#1\rangle\!\rangle} % double brackets for puiseux series domains
...
$P\cdot f=(Q\cdot f)'$ implies, for instance, $P\cdot\int_0^1 f(x,t)dt = (Q\cdot f)(1) - (Q\cdot f)(0)$.
A telescoper $P$ for $f$ thus gives rise to an annihilating operator for the
definite integral $F(x)=\int_0^1 f(x,t)dt$. In the common case when the right hand side
...
terms~\cite{chen15a} and binomial sums~\cite{bostan15}. In the present paper, we
...
The second way consists in showing that the vector space generated by $\{\,[\partial_x^i\cdot f]:i\in\set N\,\}$
$\mathrm{Const}_x(D)$ has finite dimension. This approach was taken in~\cite{BCCL2010,bostan13a}. It has the
...
certificate. The algorithms presented in the present paper can find
...
creative telescoping by showing that the $K$-vector space generated by $\{\,[\partial_x^if]:i\in\set N\,\}$
...
\bibitem{Chevalley1951}
C.~Chevalley.
\newblock {\em Introduction to the {T}heory of {A}gebraic {F}unctions of {O}ne
  {V}ariable}, volume~VI of {\em Mathematical Surveys}.
...
\newblock An extension of {Z}eilberger's fast algorithm to general holonomic
  functions.
\newblock {\em Discrete Mathematics}, 217:115--134, 2000.

\bibitem{ACA1992}
K.~O. Geddes, S.~R. Czapor, and G.~Labahn.
\newblock {\em {A}lgorithms for {C}omputer {A}lgebra}.
...
\newblock An algorithm for computing an integral basis in an algebraic function
  field.
\newblock {\em Journal of Symbolic Computation}, 18(4):353--363, 1994.
...
\bibitem{Koepf1998}
W.~Koepf.
\newblock {\em Hypergeometric {S}ummation}.
...
\newblock {\em {M}athematics of {C}omputation}, Published electr., 2015.
...
\bibitem{Rybowicz:1991:ACI:120694.120715}
M.~Rybowicz.
...
\bibitem{schlesinger95}
L.~Schlesinger.
\newblock {\em Handbuch der {T}heorie der linearen {D}ifferentialgleichungen},
  volume~1.
\newblock Teubner, 1895.

\bibitem{trager84}
B.~M. Trager.
\newblock {\em On the Integration of Algebraic Functions}.
\newblock PhD thesis, MIT, 1984.

\bibitem{Zeilberger1990c}
D.~Zeilberger.
\newblock A fast algorithm for proving terminating hypergeometric identities.
\newblock {\em Discrete Mathematics}, 80(2):207--211, 1990.
...
\newblock {\em Journal of Symbolic Computation}, 11(3):195--204, 1991.
