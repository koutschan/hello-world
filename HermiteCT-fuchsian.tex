...
\end{corollary}
\begin{proof}
Note that the exponents~$e_i$ in Lemma~\ref{lemma:nopoles-space} differ from
the~$r_i$ only by sign. In the proof of Lemma~\ref{lemma:bound-exps} it was
shown that $r_i\geq-\frac12(n-1)(N-1)$. The estimate on the dimension of~$V$
