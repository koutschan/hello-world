...
theorem~\citep[page 9, Corollary 3]{Chevalley1951}). The results of~\cite{chen16}
...
property~\citep[page 50, Theorem 1]{trager84}. Essentially the same argument
...
By Proposition~7 of~\cite{chen14a}, we have $\tilde e \mid e$ and $x^{\tilde{\lambda}} \tilde{e} \mid x^\lambda e$.
