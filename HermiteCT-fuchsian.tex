...
\begin{lemma}
  ...
  Let $N$ be the number of points $a\in\bar C\cup\{\infty\}$ where at least one of the $\omega_i$ has at least
...
\begin{proof}
  ...
  Moreover, if $r\in\set Z$ is such that $x^{-r}\omega_i$ is integral at infinity, then we must have
...
\begin{proof}
  ...
  We show that $B=\{\,x^j\omega_i : i=1,\dots,n; j=0,\dots,e_i\,\}$ is a basis.
