...
\begin{frontmatter}
  ...
  \title{Reduction-Based Creative~Telescoping for Fuchsian D-finite~Functions\footnote{S.\ Chen was supported by the NSFC grants
11501552, 11688101 and by the President Fund of the Academy of
...
a telescoper for~$f$, and $Q$ a certificate for~$P$. Among all telescopers for $f$,
there is a unique one with its leading coefficient 1 and of smallest possible order,
which is called the \emph{minimal} telescoper.
...
guaranteed to find the minimal telescoper for $f$. This approach
...
order of the minimal telescoper. In particular, it implies the existence of
telescopers.
...
We will use below the integral bases of \cite{kauers15b} in very much the same
way as Trager used integral bases in his integration algorithm. For another recent
application of integral bases for D-finite functions, see~\citep{JSC_Erdal}.
